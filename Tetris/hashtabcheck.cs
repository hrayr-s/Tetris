...
namespace Tetris
{
    ...
    {
        /**
         * Below are methods for each of figure to allow/disallow move of the figure to the left, right ot bottom.
         * All the methods shall return same order of values: [left, right, bottom].
         */
